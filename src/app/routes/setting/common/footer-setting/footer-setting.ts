...
@Component({
    ...
    templateUrl: 'footer-setting.html'
})
export class FooterSetting implements OnInit {
    ...
    ngOnInit() {
        this.url = this.we7.getWebUrl('settingget', { code: 'footer.setting' });
